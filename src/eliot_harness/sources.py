...
MANIFESTS = {
    ...
    "maps": SourceManifest("maps", "Maps", "Directions and map handoff through Apple Maps.", "medium", ("directions", "search_place"), ("open_directions",)),
    "music": SourceManifest("music", "Music", "Music playback/search handoff.", "medium", ("search_library",), ("play", "pause")),
    "podcasts": SourceManifest("podcasts", "Podcasts", "Podcast search/play handoff.", "medium", ("search",), ("open_search",)),
