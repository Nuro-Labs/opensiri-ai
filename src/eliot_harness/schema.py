...
OPENAI_TOOLS = [
    ...
    {"type": "function", "function": {"name": "file_analyze", "description": "Find and analyze a local file from allowed roots. The harness extracts bounded text locally; optional analysis model receives only that extracted text.", "parameters": {"type": "object", "properties": {"query": {"type": "string"}, "question": {"type": "string"}, "path": {"type": "string"}}, "required": ["query"]}}},
    ...
    {"type": "function", "function": {"name": "browser_play_last_youtube", "description": "Open the most recently watched YouTube video from Chrome history. Use for 'last video I was watching'.", "parameters": {"type": "object", "properties": {}, "required": []}}},
