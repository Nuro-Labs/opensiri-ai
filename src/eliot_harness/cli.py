...
def main() -> None:
    ...
    ap.add_argument("--model-url", default="https://hypersave-resource.services.ai.azure.com/openai/v1/chat/completions")
    ap.add_argument("--model-name", default="grok-4.3")
