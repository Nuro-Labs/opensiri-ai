    ...
    var body: some View {
        Form {
            ...
            Section("Quick Source Toggles") {
                ...
                Toggle("Allow Mail Send/Drafts", isOn: $state.enableMailWrite)
                Toggle("Messages Read", isOn: $state.enableMessages)
                Toggle("Allow Message Send", isOn: $state.enableMessagesWrite)
                ...
                Toggle("Allow Browser Actions", isOn: $state.enableBrowserWrite)
                Toggle("System Controls", isOn: $state.enableSystem)
                Toggle("Allow System Changes", isOn: $state.enableSystemWrite)
